...
declare global {
    ...
    /**
     * Make the Cicada object globally available
     */
    ...
    interface ServiceContainer extends SubContainer<'service'> {
        ...
        cicadaDiscountCampaignService: CicadaDiscountCampaignService;
    ...
    /**
     * @see Cicada\Core\Framework\Api\EventListener\ErrorResponseFactory
     */
    interface CicadaHttpError {
        code: string;
        status: string;
        title: string;
        detail: string;
        meta?: {
            ...
            parameters?: object;
            previous?: CicadaHttpError;
        };
        trace?: { [key: string]: string };
    }

    interface StoreApiException extends CicadaHttpError {
        meta?: CicadaHttpError['meta'] & {
