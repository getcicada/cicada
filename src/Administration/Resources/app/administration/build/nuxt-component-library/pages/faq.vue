<template>
    <div class="page--faq">
        ...
        <h3>Answer:</h3>
        This component library is a collection of all components currently used in the Cicada Administration.
        ...
        <h3>Answer:</h3>
        The <a href="https://cicada.github.io/meteor-component-library/">meteor component library</a> is the successor to this component library.
