...
use Cicada\Core\Test\Stub\DataAbstractionLayer\StaticEntityWriterGateway;
 ...
 *
 * @phpstan-type ResultTypes EntitySearchResult<TEntityCollection>|AggregationResultCollection|mixed|EntityCollection|IdSearchResult|array
 */
class StaticEntityRepository extends EntityRepository
{
    ...
    /**
     * @param callable(Criteria, Context): (ResultTypes)|EntitySearchResult ...$searches
     */
