...
use Cicada\Frontend\Member\Aggregate\MemberGroupTranslation\MemberGroupTranslationCollection;
...
use Cicada\Core\Content\Product\Channel\Sorting\ProductSortingTranslationCollection;
...
class LanguageEntity extends Entity
{
     ...
     * @deprecated tag:v6.7.0 - Will be natively typed
     */
    protected $channelDefaultAssignments;
    ...
    /**
     * @var MemberGroupTranslationCollection|null
     *
     * @deprecated tag:v6.7.0 - Will be natively typed
     */
    protected $memberGroupTranslations;
     ...
     * @deprecated tag:v6.7.0 - Will be natively typed
     */
    protected $channelTypeTranslations;
    ...
    public function getMemberGroupTranslations(): ?MemberGroupTranslationCollection
    {
        return $this->memberGroupTranslations;
    }

    public function setMemberGroupTranslations(MemberGroupTranslationCollection $memberGroupTranslations): void
    {
        $this->memberGroupTranslations = $memberGroupTranslations;
    }
