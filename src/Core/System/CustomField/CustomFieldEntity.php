...
class CustomFieldEntity extends Entity
{
     ...
     * @deprecated tag:v6.7.0 - Will be natively typed
     */
    protected $allowMemberWrite = false;
    ...
    public function isAllowMemberWrite(): bool
    {
        return $this->allowMemberWrite;
    }

    public function setAllowMemberWrite(bool $allowMemberWrite): void
    {
        $this->allowMemberWrite = $allowMemberWrite;
    }
