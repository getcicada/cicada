...
class UserEntity extends Entity
{
    ...
    public function getCreatedMembers(): ?MemberCollection
    {
        return $this->createdMembers;
    }

    public function setCreatedMembers(MemberCollection $createdMembers): void
    {
        $this->createdMembers = $createdMembers;
    }

    public function getUpdatedMembers(): ?MemberCollection
    {
        return $this->updatedMembers;
    }

    public function setUpdatedMembers(MemberCollection $updatedMembers): void
    {
