...
#[Package('frontend')]
class FrontendApiInfoController
{
    ...
    #[Route(path: '/store-api/_info/openapi3.json', defaults: ['auth_required' => '%cicada.api.api_browser.auth_required_str%'], name: 'store-api.info.openapi3', methods: ['GET'])]
    ...
    #[Route(path: '/store-api/_info/open-api-schema.json', defaults: ['auth_required' => '%cicada.api.api_browser.auth_required_str%'], name: 'store-api.info.open-api-schema', methods: ['GET'])]
    ...
    #[Route(path: '/store-api/_info/swagger.html', defaults: ['auth_required' => '%cicada.api.api_browser.auth_required_str%'], name: 'store-api.info.swagger', methods: ['GET'])]
    /**
    ...
    #[Route(path: '/store-api/_info/stoplightio.html', defaults: ['auth_required' => '%cicada.api.api_browser.auth_required_str%'], name: 'store-api.info.stoplightio', methods: ['GET'])]
    ...
    #[Route(path: '/store-api/_info/routes', name: 'store-api.info.routes', methods: ['GET'], defaults: ['auth_required' => '%cicada.api.api_browser.auth_required_str%'])]
