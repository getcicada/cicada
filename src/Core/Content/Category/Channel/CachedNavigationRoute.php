...
class CachedNavigationRoute extends AbstractNavigationRoute
{
     ...
     */
    private function loadNavigation(Request $request, string $active, string $rootId, int $depth, ChannelContext $context, Criteria $criteria, array $tags = []): NavigationRouteResponse
    {
    ...
    private function generateKey(string $active, string $rootId, int $depth, Request $request, ChannelContext $context, Criteria $criteria): ?string
    {
        $parts = [
            $rootId,
            $depth,
            $this->generator->getCriteriaHash($criteria),
            $this->generator->getChannelContextHash($context, [RuleAreas::CATEGORY_AREA]),
        ];
     ...
     * @return array<string>
     */
    private function generateTags(array $tags, string $active, string $rootId, int $depth, Request $request, StoreApiResponse $response, ChannelContext $context, Criteria $criteria): array
    {
        $tags = array_merge(
            $tags,
