...
class Configuration implements ConfigurationInterface
{
    ...
    private function createApiSection(): ArrayNodeDefinition
    {
        ...
        $rootNode
            ...
            ->setDeprecated('cicada/core', '6.7.0.0', 'private_key_path is deprecated and will be removed with Cicada 6.7')
            ->defaultValue('file://%kernel.project_dir%/config/jwt/private.pem')
            ->end()
            ->scalarNode('private_key_passphrase')
            ->setDeprecated('cicada/core', '6.7.0.0', 'private_key_passphrase is deprecated and will be removed with Cicada 6.7')
            ->defaultValue('cicada')
            ->end()
            ->scalarNode('public_key_path')
            ->setDeprecated('cicada/core', '6.7.0.0', 'public_key_path is deprecated and will be removed with Cicada 6.7')
    ...
    private function createCacheSection(): ArrayNodeDefinition
    {
        ...
        $rootNode
            ...
            ->end()
            ->scalarNode('dsn')
            ->setDeprecated('cicada/core', '6.7.0.0', 'dsn is deprecated and will be removed with Cicada 6.7. Use connection instead.')
