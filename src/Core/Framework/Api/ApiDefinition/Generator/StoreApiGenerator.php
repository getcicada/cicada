...
use Cicada\Core\Framework\Api\ApiDefinition\Generator\OpenApi\OpenApiSchemaBuilder;
...
class StoreApiGenerator implements ApiDefinitionGeneratorInterface
{
    ...
    {
        $openApi->info->description = 'This endpoint reference contains an overview of all endpoints comprising the Cicada Store API';
        $openApi->info->license = new License([
            'name' => 'MIT',
            'url' => 'https://github.com/cicada/cicada/blob/trunk/LICENSE',
        ]);
    }
