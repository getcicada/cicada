...
use Cicada\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
use Cicada\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtectionValidator;
...
class ApiController extends AbstractController
{
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Cicada\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \Cicada\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
            ...
            /*
             * Example
             * Route:           /api/order/xxxx/orderMember
             * $definition:     \Cicada\Core\Checkout\Order\Aggregate\OrderMember\OrderMemberDefinition
             */
            ...
            $criteria->addFilter(
                new EqualsFilter(
                    // filter inverse association to parent value:  order_member.order_id = xxxx
                    \sprintf('%s.%s.id', $definition->getEntityName(), $reverse->getPropertyName()),
                    $parent['value']
                )
            );
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Cicada\Core\Content\Category\CategoryDefinition
             */
