...
use Cicada\Core\Framework\Routing\Exception\ChannelNotFoundException;
...
class ApiException extends HttpException
{
    ...
    public const API_Member_ID_PARAMETER_IS_MISSING = 'FRAMEWORK__API_Member_ID_PARAMETER_IS_MISSING';
    ...
    public static function invalidChannelId(string $channelId): CicadaHttpException
    {
    ...
    public static function channelNotFound(): CicadaHttpException
    {
    ...
    public static function memberIdParameterIsMissing(): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            self::API_Member_ID_PARAMETER_IS_MISSING,
            'Parameter "memberId" is missing.',
        );
    }
