...
use Cicada\Frontend\Member\Aggregate\MemberAddress\MemberAddressEntity;
...
abstract class ZipCodeRule extends Rule
{
    ...
    protected function matchZipCode(MemberAddressEntity $address): bool
    {
    ...
    private function sanitizeZipCode(MemberAddressEntity $address): string
    {
