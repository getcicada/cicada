...
class MaintenanceModeResolver
{
    ...
    {
        $whitelist = $request->attributes->get(ChannelRequest::ATTRIBUTE_SALES_CHANNEL_MAINTENANCE_IP_WHITLELIST) ?? '';
    ...
    {
        return (bool) $request->attributes->get(ChannelRequest::ATTRIBUTE_SALES_CHANNEL_MAINTENANCE);
    }
}
