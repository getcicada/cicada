...
class EntityReader implements EntityReaderInterface
{
    ...
    private function loadManyToMany(
        ...
        // the ids are extracted in the entity hydrator (see: \Cicada\Core\Framework\DataAbstractionLayer\Dbal\EntityHydrator::extractManyToManyIds)
    ...
    private function loadOneToManyWithoutPagination(
        ...
        // build orm property accessor to add field sortings and conditions `member_address.memberId`
    ...
    private function loadOneToManyWithPagination(
        ...
        // inject sorting for foreign key, otherwise the internal counter wouldn't work `order by member_address.member_id, other_sortings`
        $sorting = array_merge(
    ...
    private function fetchPaginatedOneToManyMapping(
        ...
        // build sql accessor for foreign key field in reference table `member_address.member_id`
