...
use Cicada\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\AbstractFieldResolver;
...
class DefinitionInstanceRegistry
{
     ...
     * @internal
     *
     * @param array<string, class-string<EntityDefinition>> $definitionMap array of $entityName => $definitionServiceId, e.g. 'product' => '\Cicada\Core\Content\Product\ProductDefinition'
