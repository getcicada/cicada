...
use Cicada\Core\Framework\Store\Struct\LicenseStruct;
...
use Cicada\Core\Framework\Store\Struct\StoreActionStruct;
use Cicada\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
...
class StoreClient
{
    ...
    public function loginWithCicadaId(string $cicadaId, string $password, Context $context): void
    {
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureCicadaVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    {
        return $this->instanceService->getCicadaVersion();
    }
