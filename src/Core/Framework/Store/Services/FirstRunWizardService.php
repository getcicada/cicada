...
use Cicada\Core\Framework\Store\Struct\DomainVerificationRequestStruct;
use Cicada\Core\Framework\Store\Struct\ExtensionStruct;
use Cicada\Core\Framework\Store\Struct\FrwState;
use Cicada\Core\Framework\Store\Struct\LicenseDomainCollection;
use Cicada\Core\Framework\Store\Struct\LicenseDomainStruct;
use Cicada\Core\Framework\Store\Struct\PluginCategoryStruct;
use Cicada\Core\Framework\Store\Struct\PluginRecommendationCollection;
use Cicada\Core\Framework\Store\Struct\PluginRegionCollection;
use Cicada\Core\Framework\Store\Struct\PluginRegionStruct;
...
class FirstRunWizardService
{
    ...
    public function frwLogin(string $cicadaId, string $password, Context $context): void
    {
        $accessTokenResponse = $this->frwClient->frwLogin($cicadaId, $password, $context);
