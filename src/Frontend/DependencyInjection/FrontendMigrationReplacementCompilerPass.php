...
#[Package('frontend')]
class FrontendMigrationReplacementCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $migrationSourceV3->addMethodCall('addDirectory', [$migrationPath . '/V6_3', 'Cicada\Frontend\Migration\V6_3']);

        $migrationSourceV4 = $container->getDefinition(MigrationSource::class . '.core.V6_4');
        $migrationSourceV4->addMethodCall('addDirectory', [$migrationPath . '/V6_4', 'Cicada\Frontend\Migration\V6_4']);
        ...
        foreach ($majors as $major) {
            ...
            if (\is_dir($migrationPathV5)) {
                ...
                $migrationSource->addMethodCall('addDirectory', [$migrationPathV5, 'Cicada\Frontend\Migration\\' . $major]);
            }
        }
    }
}
