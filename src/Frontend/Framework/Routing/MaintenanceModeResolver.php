...
class MaintenanceModeResolver
{
    ...
    private function isChannelRequest(): bool
    {
        ...
        return (bool) $main?->attributes->get(ChannelRequest::ATTRIBUTE_IS_SALES_CHANNEL_REQUEST);
    }
    ...
    private function isMaintenanceModeActive(): bool
    {
        ...
        return (bool) $main?->attributes->get(ChannelRequest::ATTRIBUTE_SALES_CHANNEL_MAINTENANCE);
    }

    private function isClientAllowed(Request $request): bool
    {
        $main = $this->requestStack->getMainRequest();
        $whitelist = $main?->attributes->get(ChannelRequest::ATTRIBUTE_SALES_CHANNEL_MAINTENANCE_IP_WHITLELIST) ?? '';
