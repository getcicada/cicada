...
use Cicada\Frontend\Theme\Validator\SCSSValidator;
...
#[\Cicada\Core\Framework\Log\Package('frontend')]
class ThemeCompiler implements ThemeCompilerInterface
{
    ...
    public function compileTheme(
        ...
        if ($themePrefix !== $oldThemePrefix) {
            ...
            $this->messageBus->dispatch(
                new DeleteThemeFilesMessage($oldThemePrefix, $channelId, $themeId),
                $stamps
            );
        }
    ...
    private function compileStyles(
        ...
        if ($this->autoPrefix === true) {
            Feature::triggerDeprecationOrThrow('v6.7.0.0', 'Autoprefixer is deprecated and will be removed without replacement, including the config frontend.theme.auto_prefix_css.');
