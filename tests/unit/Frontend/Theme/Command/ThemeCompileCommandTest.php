...
use Cicada\Frontend\Theme\Command\ThemeCompileCommand;
...
class ThemeCompileCommandTest extends TestCase
{
    ...
    {
        $salesChannelIdSkip1 = 'channel-id1';
        $salesChannelIdSkip2 = 'channel-id2';
        $salesChannelIdIncluded1 = 'channel-id3';
        $salesChannelIdIncluded2 = 'channel-id4';
        $themeId = 'theme-id';
